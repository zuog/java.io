...
GitHub 的 Blog 就这么开通了。

[跳过废话，直接看技术实现 ](#build)



2015 年，GitHub 总算有个地方可以好好写点东西了。
...
本来觉得最大的缺点可能是 GitHub 在国内访问起来太慢，所以第二天一起床就到 GitCafe(Chinese GitHub Copy) 迁移了一个[镜像](http://GitHubpro.gitcafe.io)出来，结果还是巨慢。
